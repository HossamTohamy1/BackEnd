        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowAddAllToCart = table.Column<bool>(type: "bit", nullable: false),
                    AddAllToCartText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShowToolbar = table.Column<bool>(type: "bit", nullable: false),
                    ShowSort = table.Column<bool>(type: "bit", nullable: false),
                    ShowCount = table.Column<bool>(type: "bit", nullable: false),
                    ShowProductColor = table.Column<bool>(type: "bit", nullable: false),
                    ShowProductSize = table.Column<bool>(type: "bit", nullable: false),
                    ShowProductPrice = table.Column<bool>(type: "bit", nullable: false),
                    ShowProductOldPrice = table.Column<bool>(type: "bit", nullable: false),
                    ShowProductStock = table.Column<bool>(type: "bit", nullable: false),
                    ShowRemoveAction = table.Column<bool>(type: "bit", nullable: false),
                    ShowMoveToCartAction = table.Column<bool>(type: "bit", nullable: false),
                    EmptyStateTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmptyStateSubtitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmptyStateButtonText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShowEmptyStateIllustration = table.Column<bool>(type: "bit", nullable: false),
                    ShowTrustBadges = table.Column<bool>(type: "bit", nullable: false),
                    TrustBadgesJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoritesPageConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentOffersTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BundlesTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BundlesSubtitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OffersPageConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BundleOfferItems_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPrices_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDelivery = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsRead = table.Column<bool>(type: "bit", nullable: false),
                    SupportConversationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankTransfers_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderEditLogs_Users_EditorId",
                        column: x => x.EditorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BundleOfferItems_ProductId",
                table: "BundleOfferItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderEditLogs_EditorId",
                table: "OrderEditLogs",
                column: "EditorId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderEditLogs_OrderId",
                table: "OrderEditLogs",
                column: "OrderId");
