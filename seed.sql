...
BEGIN
    ...
    -- Duplicate email user 1
    INSERT INTO "Users" ("Id", "Name", "Email", "Phone", "PasswordHash", "CountryId", "Role", "PreferredLanguage", "CreatedAt", "IsActive", "IsDeleted")
    VALUES (user2_id, 'Jane Duplicate', 'duplicate@example.com', '+1234567891', '$2a$11$WvN2L65Z4Q2U.E0.a2O77uG9c88O559B.Qo8a8O64R.e1k6z8Zq/m', country_id, 3, 'en', NOW(), true, false);

    -- Duplicate email user 2 (different casing)
    INSERT INTO "Users" ("Id", "Name", "Email", "Phone", "PasswordHash", "CountryId", "Role", "PreferredLanguage", "CreatedAt", "IsActive", "IsDeleted")
    VALUES (user3_id, 'Jim DUPLICATE', 'DUPLICATE@example.com', '+1234567892', '$2a$11$WvN2L65Z4Q2U.E0.a2O77uG9c88O559B.Qo8a8O64R.e1k6z8Zq/m', country_id, 3, 'en', NOW(), true, false);
