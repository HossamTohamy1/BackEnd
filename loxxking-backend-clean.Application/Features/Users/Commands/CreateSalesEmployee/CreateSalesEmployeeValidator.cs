...
public class CreateSalesEmployeeValidator : AbstractValidator<CreateSalesEmployeeCommand>
{
    public CreateSalesEmployeeValidator(IStringLocalizer<SharedResource> localizer)
    {
